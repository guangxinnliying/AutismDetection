...
recordfile='./bestmodels/10foldrecord.txt'
...
for current_fold in range(total_fold):
    ...
    model1=torch.load('./bestmodels/MobileNetV1F'+str(current_fold)+'.pth')
    model2=torch.load('./bestmodels/MobileNetV2F'+str(current_fold)+'.pth')

    row_i=0

    y=[9]*len(testset) #len(testset) 是测试集中包含图片的数量
    #下面的变量是MoblieNetV1的
    pred_per1=[9.]*len(testset)    
    TP1=0
    TN1=0
    FP1=0
    FN1=0
    #下面的变量是MoblieNetV2的
    pred_per2=[9.]*len(testset)    
    TP2=0
    TN2=0
    FP2=0
    FN2=0
    #下面的变量是MoblieNetV1+MoblieNetV2的
    pred_per3=[9.]*len(testset)    
    TP3=0
    TN3=0
    FP3=0
    FN3=0
    ...
    file.write("current_fold is:"+str(current_fold))
...
file.write("test_acc is:"+str(round(total_test_acc1/total_fold,4))+'\n')    
file.write("sensitivity is:"+str(round(total_sensitivity1/total_fold,4))+'\n')
file.write("specificity is:"+str(round(total_specificity1/total_fold,4))+'\n')
file.write("error_rate is:"+str(round(total_error_rate1/total_fold,4))+'\n')
file.write("auc is:"+str(round(total_roc_auc1/total_fold,4))+'\n')
file.write("G_Mean is:"+str(round(total_G_Mean1/total_fold,4))+'\n')
file.write("F_Measure is:"+str(round(total_F_Measure1/total_fold,4))+'\n')
file.write('\n')
file.write("Evaluation index of MobileNetV2:"+'\n')
file.write("test_acc is:"+str(round(total_test_acc2/total_fold,4))+'\n')    
file.write("sensitivity is:"+str(round(total_sensitivity2/total_fold,4))+'\n')
file.write("specificity is:"+str(round(total_specificity2/total_fold,4))+'\n')
file.write("error_rate is:"+str(round(total_error_rate2/total_fold,4))+'\n')
file.write("auc is:"+str(round(total_roc_auc2/total_fold,4))+'\n')
file.write("G_Mean is:"+str(round(total_G_Mean2/total_fold,4))+'\n')
file.write("F_Measure is:"+str(round(total_F_Measure2/total_fold,4))+'\n')
file.write('\n')
file.write("test_acc is:"+str(round(total_test_acc3/total_fold,4))+'\n')    
file.write("sensitivity is:"+str(round(total_sensitivity3/total_fold,4))+'\n')
file.write("specificity is:"+str(round(total_specificity3/total_fold,4))+'\n')
file.write("error_rate is:"+str(round(total_error_rate3/total_fold,4))+'\n')
file.write("auc is:"+str(round(total_roc_auc3/total_fold,4))+'\n')
file.write("G_Mean is:"+str(round(total_G_Mean3/total_fold,4))+'\n')
file.write("F_Measure is:"+str(round(total_F_Measure3/total_fold,4))+'\n')
file.write('\n')
file.close() 

print("Avg of evaluation index of MobileNetV1:")    
print("test_acc is:",round(total_test_acc1/total_fold,4))    
print("sensitivity is:",round(total_sensitivity1/total_fold,4)) 
print("specificity is:",round(total_specificity1/total_fold,4))    
print("error_rate is:",round(total_error_rate1/total_fold,4))  
print("auc is:",round(total_roc_auc1/total_fold,4))    
print("G_Mean is:",round(total_G_Mean1/total_fold,4))    
print("F_Measure is:",round(total_F_Measure1/total_fold,4))

print("Avg of evaluation index of MobileNetV2:")    
print("test_acc is:",round(total_test_acc2/total_fold,4))    
print("sensitivity is:",round(total_sensitivity2/total_fold,4)) 
print("specificity is:",round(total_specificity2/total_fold,4))    
print("error_rate is:",round(total_error_rate2/total_fold,4))  
print("auc is:",round(total_roc_auc2/total_fold,4))    
print("G_Mean is:",round(total_G_Mean2/total_fold,4))    
print("F_Measure is:",round(total_F_Measure2/total_fold,4))

print("Avg of evaluation index of MobileNetV1+MobileNetV2:")    
print("test_acc is:",round(total_test_acc3/total_fold,4))    
print("sensitivity is:",round(total_sensitivity3/total_fold,4)) 
print("specificity is:",round(total_specificity3/total_fold,4))    
print("error_rate is:",round(total_error_rate3/total_fold,4))  
print("auc is:",round(total_roc_auc3/total_fold,4))    
print("G_Mean is:",round(total_G_Mean3/total_fold,4))    
print("F_Measure is:",round(total_F_Measure3/total_fold,4))
